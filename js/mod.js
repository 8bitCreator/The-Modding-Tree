...
function getPointGen() {
    ...
    gain = gain.mul(buyableEffect("p", 11)) // Multiply by the effect of buyable in the Primitive layer

    // Multiply by the knowledge boost from the Fire layer if it's unlocked
