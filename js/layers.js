addLayer("e", {
    ...
    buyables: {
        ...
        22: {
            ...
            effectDisplay() { return format(this.effect()) + "x"; },
            style: { 'background-color': '#00BFFF', 'color': '#FFFFFF' }, // Geyser color (deep sky blue)
        },
        23: {
            ...
            effectDisplay() { return format(this.effect()) + "x"; },
            style: { 'background-color': '#A0522D', 'color': '#FFFFFF' }, // Quake color (sienna brown)
        },
        24: {
            ...
            effectDisplay() { return format(this.effect()) + "x"; },
            style: { 'background-color': '#B0E0E6', 'color': '#FFFFFF' }, // Tornado color (powder blue)
        },
    },
